...
Progressive Web App für den Habits-Teil des SK8-Projekts: tägliche Gewohnheiten, Schlaf und Knie-Check auf dem Weg zum Contest am 18. September 2027 in Braunschweig.
...
| Befehl | Zweck |
|---|---|
| `pnpm dev` | Entwicklungsserver auf Port 5175 |
...
```sh
docker build --build-arg VITE_API_URL=http://localhost:8000 --build-arg VITE_API_KEY=dev-key-change-me -t sk8-habits .
docker run --rm -p 8080:80 sk8-habits
```
